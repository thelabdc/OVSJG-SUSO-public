...
def test__convert_recipient_to_row():
  ...
  assert converted == ['John', 'Doe', None, '1350 Pennsylvania Avenue',
                       None, None, 'Washington', 'DC', '20004', None]


def test__recipient_row_to_xml():
  converted = click2mail._recipient_row_to_xml(click2mail._convert_recipient_to_row(JOHN_DOE))
